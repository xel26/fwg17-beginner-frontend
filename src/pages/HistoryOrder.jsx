...
import { FiMessageSquare, FiAlignRight, FiCalendar, FiChevronDown } from 'react-icons/fi'
        ...
        <div className="flex flex-col sm:flex-row w-5/6 gap-4">
          <div className="sm:w-2/3 flex flex-col gap-8 sm:gap-10">
            ...
            <div className="flex flex-col gap-4 h-fit sm:h-[33.5rem]">
                {
                  card.map(index => (
                    <CardHistoryOrder key={index} numberOrder="#12354-09893" date="23 January 2023" total="40" statusDelivery="On Progress"/>
                  ))
                }
            </div>
